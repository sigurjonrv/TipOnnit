  ...
  return (
    <Wrapper opaque reverse {...props}>
      <InnerWrapper>
        ...
        <Section>
          <Text>
            <strong>TipOnnIt</strong> is an Application, that allows a group of friends to create local Fantacy/Draft lobby.  This application is still under development so be patiant, and please let me know if you have any good ideas or if you want to contribute.
          </Text>
